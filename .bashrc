...
alias mqtt_stat='sudo systemctl status mosquitto.service'
alias mqtt_stop='sudo systemctl stop mosquitto.service'
alias mqtt_restart='sudo systemctl restart mosquitto.service'
